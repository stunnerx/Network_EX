...
plt.savefig("E:/Code/Pycharm_Project/network_exp1/nn_loss_curve.png", dpi=300)

plt.close()

print("Loss曲线已保存到: E:/Code/Pycharm_Project/network_exp1/nn_loss_curve.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("E:/Code/Pycharm_Project/network_exp1/nn_true_vs_pred.png", dpi=300)
plt.close()

print("真实值-预测值散点图已保存到: E:/Code/Pycharm_Project/network_exp1/nn_true_vs_pred.png")
